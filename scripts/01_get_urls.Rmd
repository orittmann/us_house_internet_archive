...
```{r}
download.file(url = "http://archive-media.granicus.com:443/OnDemand/clerkhouse/clerkhouse_175a83e8-554a-4d64-b3fe-2dd90416285a.mp4",
              destfile = "videos/16_Jan_2015")
```
...
save(sessions_urls, file = "sessions_urls.Rdata")
```

```{r}
load("sessions_urls.Rdata")

table(is.na(sessions_urls$mp3_url))
table(is.na(sessions_urls$mp4_url))
```
